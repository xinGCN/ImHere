...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int STATE_CHAT = 2;
...
//                            fab.setVisibility(View.INVISIBLE);
//                            where = STATE_USER;
                        getSupportFragmentManager().beginTransaction().replace(R.id.activity_main_fragment,new UserFragment()).commit();
                        fab.setVisibility(View.INVISIBLE);
                        where = STATE_USER;
                    }
                    break;
...
//        Global.user.setAccount("15996464635");
    }
